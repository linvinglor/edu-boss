<template>
  <div class="course-section">
    ...
    >
      <el-form ref="section-form" :model="section" label-width="100px" :rules="sectionRules">
    ...
    >
      <el-form ref="lesson-form" :model="lesson" label-width="100px" :rules="lessonRules">
        <el-form-item label="课程名称">
          <el-input
            :value="course.courseName"
            autocomplete="off"
  ...
  data () {
    ...
    return {
      ...
      sectionRules: {
        ...
        description: [
          { required: true, message: '请输入章节描述', trigger: 'change' }
        ]
      },
      lessonRules: {
        theme: [
