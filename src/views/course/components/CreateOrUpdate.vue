<template>
  <el-card>
    ...
    <el-form label-width="120px" :rules="rules" ref="course" :model="course">
      <div v-show="activeStep === 0">
        <el-form-item label="课程名称" prop="courseName">
          <el-input v-model="course.courseName" maxlength="20"></el-input>
        </el-form-item>
        <el-form-item label="课程简介" prop="brief">
          <el-input v-model="course.brief" maxlength="100"></el-input>
        </el-form-item>
        ...
        <el-form-item label="讲师姓名" prop="teacherDTO.teacherName">
          <el-input v-model="course.teacherDTO.teacherName" maxlength="20"></el-input>
        </el-form-item>
        <el-form-item label="讲师简介" prop="teacherDTO.description">
          <el-input v-model="course.teacherDTO.description" maxlength="100"></el-input>
        </el-form-item>
...
export default Vue.extend({
  ...
  data () {
    return {
      ...
      rules: {
        ...
        previewFirstField: [
          { required: true, message: '请选择课程描述', trigger: 'change' }
        ],
  ...
  methods: {
    ...
    handleSave () {
      (this.$refs.course as Form).validate(async (valid) => {
        if (valid) {
    ...
    next () {
      (this.$refs.course as Form).validate((valid) => {
        if (valid) {
          this.activeStep++
        }
      })
